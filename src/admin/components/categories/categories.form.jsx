...
export default function CategoriesForm({ action }) {
    ...
    return (
        <section className="container flex flex-col justify-center items-center">
            <h1 className="mt-24 text-4xl font-light text-center">
                {action === "update" ? "Update Category" : "Create Category"}
            </h1>
            <div className="w-full md:w-3/4 flex flex-col justify-center md:justify-start pt-8 md:pt-0 px-4 md:px-8 lg:px-32">
                <Formik
